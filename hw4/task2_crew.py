...
PROVIDERS = {
    "mine": lambda x, w, b: ln_fwd_wrapper(x, w, b)[0],
    "torch": lambda x, w, b: ln_torch(x, w, b),
    "torch-compile": torch.compile(lambda x, w, b: ln_torch(x, w, b)),
}
